        ...
        <div className='flex justify-evenly mt-10 flex-wrap'>
            
                {
                    ProjectData.map((data)=>{
                        return(
                        <div className='w-[90%] rounded-lg h-[400px] bg-sky-800 mt-3 transition ease-in-out delay-1000 hover:-translate-y-2 hover:scale-110 hover:bg-sky-500 duration-700' key={data.id}>
                                    ...
                                    <div className='flex mt-4 ml-7'>
                                        {
                                            data.Stacks.map((data,key)=>{
                                                return(
                                                    <div className='w-[50px] h-[50px] rounded-full bg-white ml-2' key={key}>
