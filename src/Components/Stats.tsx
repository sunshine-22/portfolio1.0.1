    ...
    <div>
        <div className='flex flex-wrap mt-[150px] justify-evenly'>
            <div className='h-[200px] w-[240px]'>
                <div className='mt-3'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="70" viewBox="0 0 48 48" className='m-auto'><path fill="none" stroke="green" stroke-linecap="round" stroke-linejoin="round" d="M42.79 12.72L21.55 41.78L3.79 28.79l4.87-6.66l11.1 8.12l16.37-22.4l3.312 2.45l.342.223l-19.167 25.533l-11.687-8.43"/></svg>
                </div>
