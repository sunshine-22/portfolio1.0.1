...
export default function Home() {
  return (
    <div>
      <div className='grid grid-cols-12 gap-1 place-content-center mt-14'>
          <div className='col-start-1 col-end-7 h-[200px] mt-[230px]'>
              <p className='font-bold text-[60px] subpixel-antialiased animate-fade-right animate-duration-[1000ms] animate-ease-in ml-11'>Hi, I'm sabarish</p>
              <p className='text-[18px] ml-11 animate-fade-right animate-delay-[1100ms] animate-ease-in font-mono'>Full Stack Developer |Data Engineer |Android/Ios Developer |Cyber Analyst | Python Developer</p>
          ...
          <div className='col-start-8 col-end-13 h-[700px] animate-fade-up animate-delay-[900ms]'>
            <Image src={Coder} alt='s'></Image>
          </div>
