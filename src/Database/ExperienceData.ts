...
export const ExperienceData = [
    ...
    },
    {
        ...
        Description : "During my internship as a Data Engineer, I gained valuable hands-on experience in the world of data engineering and contributed to various data-related projects. My key responsibilities included:During my internship as a Data Engineer at [Company Name], I gained valuable hands-on experience in the world of data engineering and contributed to various data-related projects. My key responsibilities included,Collaborating with the data engineering team to design, build, and maintain data pipelines.Extracting, transforming, and loading (ETL) data from various sources into data warehouses.Assisting in data modeling and database design for efficient storage and retrieval.Writing and optimizing SQL queries to extract insights from large datasets.Developing and maintaining data integration solutions using tools like Apache Kafka, Apache Nifi, and Apache Spark..",
